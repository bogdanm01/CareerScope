...
import { BriefcaseBusiness, Building2, CalendarDays, CheckCircle2, ClipboardCheck, FilePlus2, Search, UserRoundPen, UsersRound } from 'lucide-react';
...
export const DashboardPage = () => {
  ...
  const isOnboardingComplete = session?.user.onboardingStatus === 'Completed';
            ...
            <Card className="border border-divider bg-content2 shadow-none">
              <Card.Content className="p-4">
                ...
                <strong className="mt-2 block text-sm font-medium text-foreground">
                  {role === 'Admin' ? 'Admin workspace' : 'Recruiter workspace'}
                </strong>
              </Card.Content>
            </Card>
          </div>
