...
export const jobPostingSkill = pgTable(
  'job_posting_skill',
  {
  ...
  (table) => [
    index('job_posting_skill_job_posting_id_idx').on(table.jobPostingId),
    index('job_posting_skill_skill_id_idx').on(table.skillId),
  ],
);
