...
import { getJobApplicationDetail, type JobApplicationDetail } from '../lib/job-applications-api';
    ...
    return (
      <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl sm:p-8">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          ...
          <Link className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white" to="/panel/job-applications">
  ...
  return (
    <div className="grid gap-6">
      ...
      <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl sm:p-8">
          <h3 className="text-xl font-semibold text-white">Applicant</h3>
